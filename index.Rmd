...
We performed scRNA-seq on affected and unaffected skin from vitiligo patients, as well as healthy controls, to define the role of each cell type in coordinating autoimmunity during disease progression, and in order to analyze this high dimensional data, we have implemented a novel end-to-end scRNA data analysis package called [SignallingSingleCell](./signallingsinglecell.html). You can also interactively browse the results of our manuscript and the UMI table using [Cellxgene](./browse.html) Browser. 

All raw sequencing data was processed by the scRNA-Seq inDrop pipeline developed within the interactive pipeline manager [DolphinNext](./dolphinnext.html) ([Yukselen et. al 2020](#reference)), and currently being hosted in DolphinSuite high throughput data analysis platform. 
