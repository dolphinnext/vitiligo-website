...
Raw sequenced data was processed by the scRNA-Seq inDrop pipeline developed within the interactive pipeline manager DolphinNext. A downloadable container of all required sofware and R libraries of the indrop Pipeline can be found in both Docker Hub and GitHub. 
...
<tbody>
  <tr>
   ...
   <td style="text-align:center;width:33%; vertical-align: text-top;"> 
      ...
      <button type="button" class="btn btn-info" onclick="window.open('https://dmeta-skin.dolphinnext.com/')">Dmeta Vitiligo Demo</button>
      <br>
   </td>
   <td style="text-align:center;width:33%; vertical-align: text-top;"> 
      ...
      <br>
      <button type="button" class="btn btn-info" onclick="window.open('https://dportal-skin.dolphinnext.com/')">Dportal Vitiligo Demo</button>
      <br>
   </td>
  </tr>
</tbody>
...
Yukselen, O., Turkyilmaz, O., Ozturk, A.R. et al. DolphinNext: a distributed data processing platform for high throughput genomics. BMC Genomics 21, 310 (2020). [<a href="https://bmcgenomics.biomedcentral.com/articles/10.1186/s12864-020-6714-x">View</a>]